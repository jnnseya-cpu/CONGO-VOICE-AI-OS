 ...
 *
 * It lives in shared because both halves of the platform need it: the server
 * parses Markdown into these shapes, and the components that render them run in
 * the browser. A type that both sides use and neither owns belongs to neither.
 */
...
/** Slug for a category or a tag. Pure string work, needed on both sides. */
