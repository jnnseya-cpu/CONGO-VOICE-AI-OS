...
At the time of writing the corpus holds 13 articles in five clusters — voice and language, community health, agriculture, education and governance — twelve in French and one in English. The weakest scores 99 of 100. Run the report rather than trusting this paragraph: it is generated from the files on disk.
