...
s("AI-10", G, "src/server/ai/protocols/registry.ts", "The approval mechanism is built and every version records its approver. Constituting the clinical review board is a governance act; until then every protocol carries \"En attente du Comité de Revue Clinique\".")
...
s("DO-02", B, "infra/main.tf · infra/environments · Dockerfile", "Environments are declared as Terraform in this repository, with a container image that runs the same way in each.")
