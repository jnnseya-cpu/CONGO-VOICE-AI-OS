...
- `docs/DATA_RESIDENCY.md` — every destination citizen data can reach, generated from the declarations the platform enforces. Also produced as Word (`npm run residency:docx`) for legal review.
